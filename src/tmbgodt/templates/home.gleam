...
<html>
  ...
  ")
    let builder = string_builder.append_builder(builder, song_template.render_builder(home.songs))
    let builder = string_builder.append(builder, "
  </section>
  ...
  <select name=\"album\">
          ")
    let builder = list.fold(home.albums, builder, fn(builder, album: Album) {
            let builder = string_builder.append(builder, "
          <option value=")
